...
//A drone application that simulates fire-extinguishing drones to patrol and search for fire to put out

[RequireComponent(typeof(Collider2D))]
public class Drone : MonoBehaviour
{
    // Adam Marwan bin Husin Albasri, 22009203
    // also did the Drone and Background Modelling using Blender
