...
{
    private DroneCommunicationManager communicationManager;
...
// Danish Harith bin Ahmad Nizam, 22009489
    ...
    void Start()
    {
        ...
        communicationManager = FindObjectOfType<DroneCommunicationManager>();
...
// Manas Ismail Abdylas, 22008600
    ...
    void Partition()
    {
        ...
        // Initialize communication networks after partition
        if (communicationManager != null)
        {
            communicationManager.InitializeNetworks(highFECDrones, lowFECDrones);
        }
