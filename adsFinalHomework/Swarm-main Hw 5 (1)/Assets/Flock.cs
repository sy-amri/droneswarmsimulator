...
public class Flock : MonoBehaviour
{
    ...
    void Partition()
    {
        ...
        // Sort agents by fire extinguisher capacity using Array.Sort (O(N log N))
        agents.Sort((drone1, drone2) => drone1.fireExtinguisherCapacity.CompareTo(drone2.fireExtinguisherCapacity));
