...
public class StartBtn : MonoBehaviour
{
    ...
    [SerializeField] private GameObject startInput; // Start Input Field
    [SerializeField] private GameObject endInput;   // End Input Field
    [SerializeField] private GameObject findBtn;    // Find Button
    ...
    void Start()
    {
        ...
        if (startInput != null) startInput.SetActive(false);  // Hide Start Input initially
        if (endInput != null) endInput.SetActive(false);      // Hide End Input initially
        if (findBtn != null) findBtn.SetActive(false);        // Hide Find Button initially
    ...
    void OnStartButtonClick()
    {
        ...
        // Show Start Input, End Input, and Find Button
        if (startInput != null) startInput.SetActive(true);
        if (endInput != null) endInput.SetActive(true);
        if (findBtn != null) findBtn.SetActive(true);
